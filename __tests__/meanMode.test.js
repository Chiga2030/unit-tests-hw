...
* Класс 2: Любое кол-во одинаковых чисел в среднем равно этому числу.
* Класс 3: Упорядоченные ряды чисел всегда будут возвращать false
* Класс 4: Если в массиве есть более одной группы одинаковых чисел, равных по длинне, то в ответ получаем false.
* Класс 5: Если в массиве есть только одна группа одинаковых чисел с наибольшей длинной, а значение числа совпадает со средним значением массива, то в ответ поличаем true.
* Класс 6: В остальных случаях ожидаем false. То есть при только одной группе одинаковых чисел с наибольшей длинной, но значение числа которой не совпадает со средним значением массива.
*/
...
describe('Проверим 2 класс эквивалентности, заполнив массив одинаковыми значениями, в ответ ожидаем true', () => {
...
describe('Проверим 3 класс эквивалентности, заполним массив упорядоченными рядами чисел', () => {
